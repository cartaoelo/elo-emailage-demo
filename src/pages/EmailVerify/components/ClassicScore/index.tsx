...
const ClassicScore = (props: Props) => {
	...
	const handleSubmit = async e => {
		...
		const eloRes = await callApi('classicScore', 'verifyEmailClassicScore', {
			access_token,
			variables: {
				...values,
	...
	return (
		<>
			...
			<h1>Classic Score</h1>
			<h3 style={{ color: '#6d6d6d' }}>Verificação clássica de score</h3>
